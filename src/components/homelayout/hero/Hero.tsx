      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-4xl md:ml-12 lg:ml-20 xl:ml-28">
          <div className="flex items-center gap-3">
            ...
            <p className="type-kicker text-neutral-400 sm:text-[11px]">
          ...
          <p className="mt-8 max-w-xl text-base italic leading-relaxed text-neutral-400 sm:mt-10 sm:text-lg">
          ...
          <div className="relative z-10 mt-10 flex flex-col gap-6 sm:mt-12 sm:flex-row sm:items-center sm:gap-8">
            ...
            >
              <p className="text-neutral-500">Private. Immediate access.</p>
            ...
            <div className="grid min-w-0 grid-cols-3 gap-3 sm:gap-6 lg:gap-8">
              {stats.map((item) => (
                <div key={item.label} className="min-w-0">
                  ...
                  <p className="mt-1.5 text-[8px] uppercase leading-snug tracking-wide text-neutral-500 sm:mt-2 sm:text-[10px] lg:text-[11px]">
                    {item.label}
                  </p>
                </div>
              ))}
